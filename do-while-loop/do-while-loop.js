...
// ---------------------------------------------------------------------------------------- //
        // PENERAPAN DO WHILE LOOP
        document.writeln("1) PENERAPAN DO WHILE LOOP PADA JAVA SCRIPT");
        document.writeln("</br>");
...
// ---------------------------------------------------------------------------------------- //
        ...
        document.writeln("2) PENERAPAN DO WHILE LOOP (Perulangan do while) DENGAN STUDI KASUS LAIN PADA JAVA SCRIPT");
        document.writeln("</br>");
...
// ---------------------------------------------------------------------------------------- //
        // PENERAPAN WHILE LOOP
        document.writeln("3) PENERAPAN DO WHILE LOOP (Perulangan do while) DENGAN STUDI KASUS LAIN PADA JAVA SCRIPT");
        document.writeln("</br>");
