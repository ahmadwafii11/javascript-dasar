...
// ---------------------------------------------------------------------------------------- //
        ...
        document.writeln("1) PENERAPAN WHILE LOOP (Perulangan While) PADA JAVA SCRIPT");
        document.writeln("</br>");
...
// ---------------------------------------------------------------------------------------- //
        // PENERAPAN WHILE LOOP
        document.writeln("2) PENERAPAN WHILE LOOP (Perulangan While) DENGAN STUDI KASUS LAIN PADA JAVA SCRIPT");
        document.writeln("</br>");
...
// ---------------------------------------------------------------------------------------- //
        // PENERAPAN WHILE LOOP
        document.writeln("3) PENERAPAN WHILE LOOP (Perulangan While) DENGAN STUDI KASUS LAIN PADA JAVA SCRIPT");
        document.writeln("</br>");
