Sebelumnya, kita telah membuat beberapa function dengan menggunakan nama
Namun, kita juga bisa membuat sebuah function dengan tanpa nama, atau istilahnya adalah anonymous function.
Kita bisa membuat anonymous function dalam sebuah variable atau bisa juga kita buat ketia mengisi sebuah parameter.
Contoh penerapannya:
